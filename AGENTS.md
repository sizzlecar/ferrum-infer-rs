...
- Current Ferrum full-sweep shape after the c=4 fix, before pair-id defaulting, was c=1 `155.4 ± 1.0`, c=4 `425.6 ± 36.6`, c=16 `965.8 ± 6.4`, c=32 `1205.6 ± 55.1` tok/s. Pair-id plus combine fast path replaces the c=16/c=32 rows with c=16 `993.8 ± 26.6`, c=32 `1264.0 ± 29.4`; the 0.80× goal is not complete.
