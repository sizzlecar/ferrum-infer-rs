...
- The M3 selector now consumes known `HardwareCapabilities.sm_count` and
  `vram_bytes` when choosing default `max_sequences` and
  `max_batched_tokens`. RTX 4090-class capability keeps the c32/2048-token
