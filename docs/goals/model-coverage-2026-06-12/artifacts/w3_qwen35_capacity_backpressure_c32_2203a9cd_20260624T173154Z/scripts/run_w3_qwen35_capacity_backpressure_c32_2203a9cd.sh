...
SHA=2203a9cd9c0b1244705c756c6c204235638c8477
...
ART=/workspace/artifacts/w3_qwen35_capacity_backpressure_c32_2203a9cd_${STAMP}
...
(cargo check -p ferrum-engine -p ferrum-scheduler > "$ART/logs/cargo-check.stdout.log" 2> "$ART/logs/cargo-check.stderr.log"); echo $? > "$ART/env/cargo-check.exit"
...
summary={"artifact":str(art),"sha":"2203a9cd9c0b1244705c756c6c204235638c8477","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 CAPACITY BACKPRESSURE C32 DIAG PASS: $ART"
