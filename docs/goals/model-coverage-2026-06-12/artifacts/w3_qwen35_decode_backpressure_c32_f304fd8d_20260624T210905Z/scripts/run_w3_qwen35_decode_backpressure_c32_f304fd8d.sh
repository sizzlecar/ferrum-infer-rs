...
SHA=f304fd8de882c3bf729c314491167e8dcf8a84d5
...
ART=/workspace/artifacts/w3_qwen35_decode_backpressure_c32_f304fd8d_${STAMP}
...
summary={"artifact":str(art),"sha":"f304fd8de882c3bf729c314491167e8dcf8a84d5","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 DECODE BACKPRESSURE C32 DIAG PASS: $ART"
