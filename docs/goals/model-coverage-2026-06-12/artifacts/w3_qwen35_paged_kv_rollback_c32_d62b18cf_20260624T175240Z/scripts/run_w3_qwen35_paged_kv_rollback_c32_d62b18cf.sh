...
export FERRUM_QWEN35_LINEAR_STATE_MAX_SLOTS=32
SHA=d62b18cfe877a2b260a5ddab3bfa4772a45cb7ff
...
ART=/workspace/artifacts/w3_qwen35_paged_kv_rollback_c32_d62b18cf_${STAMP}
...
git clean -fd -e target -e .env.local > "$ART/logs/git-clean.log" 2>&1 || true
...
summary={"artifact":str(art),"sha":"d62b18cfe877a2b260a5ddab3bfa4772a45cb7ff","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 PAGED KV ROLLBACK C32 DIAG PASS: $ART"
