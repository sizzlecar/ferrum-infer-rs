...
SHA=0486ed97e97d63ff3b5ef3bc78de8fb01bb786a2
...
ART=/workspace/artifacts/w3_qwen35_fresh_kv_defer_c32_0486ed97_${STAMP}
...
summary={"artifact":str(art),"sha":"0486ed97e97d63ff3b5ef3bc78de8fb01bb786a2","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 FRESH KV DEFER C32 DIAG PASS: $ART"
