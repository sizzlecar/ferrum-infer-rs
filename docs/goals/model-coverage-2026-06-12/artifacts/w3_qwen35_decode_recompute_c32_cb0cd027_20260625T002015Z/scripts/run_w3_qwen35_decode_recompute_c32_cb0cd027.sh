...
SHA=cb0cd027026220f2b340d0b12278c373a4027c56
...
ART=/workspace/artifacts/w3_qwen35_decode_recompute_c32_cb0cd027_${STAMP}
...
find "$ART" -type f \( -name '*.log' -o -name '*.jsonl' \) ! -name '*.gz' -size +1M -print0 | xargs -0 -r gzip -f
log "FERRUM W3 QWEN35 DECODE RECOMPUTE C32 DIAG PASS: $ART"
