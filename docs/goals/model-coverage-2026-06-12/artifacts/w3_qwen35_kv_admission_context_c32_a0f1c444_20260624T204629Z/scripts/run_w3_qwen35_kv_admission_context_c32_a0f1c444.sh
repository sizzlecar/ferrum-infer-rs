...
SHA=a0f1c4444311884bc842cafe3aba56b8cd4086dd
...
ART=/workspace/artifacts/w3_qwen35_kv_admission_context_c32_a0f1c444_${STAMP}
...
summary={"artifact":str(art),"sha":"a0f1c4444311884bc842cafe3aba56b8cd4086dd","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 KV ADMISSION CONTEXT C32 DIAG PASS: $ART"
