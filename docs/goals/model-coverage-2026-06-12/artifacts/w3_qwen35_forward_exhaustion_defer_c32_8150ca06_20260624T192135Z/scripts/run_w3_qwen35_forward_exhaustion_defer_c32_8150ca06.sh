...
SHA=8150ca0641db67524422e1e9a8bdc1d3ef2d6d27
...
ART=/workspace/artifacts/w3_qwen35_forward_exhaustion_defer_c32_8150ca06_${STAMP}
...
summary={"artifact":str(art),"sha":"8150ca0641db67524422e1e9a8bdc1d3ef2d6d27","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 FORWARD EXHAUSTION DEFER C32 DIAG PASS: $ART"
