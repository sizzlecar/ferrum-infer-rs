...
SHA=2bc1e6bb49e1530a15772378f3d1f0a50595ca81
...
ART=/workspace/artifacts/w3_qwen35_scheduler_backpressure_decode_c32_2bc1e6bb_${STAMP}
...
summary={"artifact":str(art),"sha":"2bc1e6bb49e1530a15772378f3d1f0a50595ca81","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 SCHEDULER BACKPRESSURE DECODE C32 DIAG PASS: $ART"
