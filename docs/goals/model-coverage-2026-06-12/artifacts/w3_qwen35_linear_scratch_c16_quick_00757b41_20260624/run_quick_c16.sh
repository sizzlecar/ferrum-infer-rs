...
ROOT=/workspace/artifacts/w3_qwen35_linear_scratch_c16_quick_00757b41_20260624
...

{
  ...
  echo lane=W3_QWEN35_LINEAR_SCRATCH_C16_QUICK_00757B41
...
EXPECTED_SHA=00757b41d8102d5718f6048f836c4ea5a78ad414
...
summary = {
    "lane": "W3_QWEN35_LINEAR_SCRATCH_C16_QUICK_00757B41",
    "status": "passed",
...
(root / "summary.txt").write_text("W3 QWEN35 LINEAR SCRATCH C16 QUICK DIAG PASS: " + str(root) + "\n")
PY
