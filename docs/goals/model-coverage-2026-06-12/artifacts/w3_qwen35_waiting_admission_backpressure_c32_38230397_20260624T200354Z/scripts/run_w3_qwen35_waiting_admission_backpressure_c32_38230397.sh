...
SHA=38230397aab64aa8e34a96fe5dff551205b31b06
...
ART=/workspace/artifacts/w3_qwen35_waiting_admission_backpressure_c32_38230397_${STAMP}
...
summary={"artifact":str(art),"sha":"38230397aab64aa8e34a96fe5dff551205b31b06","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 WAITING ADMISSION BACKPRESSURE C32 DIAG PASS: $ART"
