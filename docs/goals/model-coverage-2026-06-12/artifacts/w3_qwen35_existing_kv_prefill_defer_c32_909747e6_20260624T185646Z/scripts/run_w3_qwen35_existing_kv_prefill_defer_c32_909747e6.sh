...
SHA=909747e61dbf7527be2e1af3362ff58b677e7658
...
ART=/workspace/artifacts/w3_qwen35_existing_kv_prefill_defer_c32_909747e6_${STAMP}
...
summary={"artifact":str(art),"sha":"909747e61dbf7527be2e1af3362ff58b677e7658","bench_exit":(art/'perf/bench.exit').read_text().strip(),"release_evidence":False}
...
log "FERRUM W3 QWEN35 EXISTING KV PREFILL DEFER C32 DIAG PASS: $ART"
