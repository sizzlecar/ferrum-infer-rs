...
ROOT=/workspace/artifacts/w3_qwen35_block_table_skip_c16_quick_a857c166_20260624
...

{
  ...
  echo lane=W3_QWEN35_BLOCK_TABLE_SKIP_C16_QUICK_A857C166
...
EXPECTED_SHA=a857c166bc319c982037b05c6222abf6b8582085
...
previous = 659.0665261344391
metric["previous_zzz104_output_tps"] = previous
if isinstance(metric["output_throughput_tps"], (int, float)):
    metric["delta_vs_zzz104_output_tps"] = metric["output_throughput_tps"] - previous
    metric["ratio_vs_zzz104_output_tps"] = metric["output_throughput_tps"] / previous
print(
    "DIAG_METRIC",
    ...
    "ratio_vs_zzz104", metric.get("ratio_vs_zzz104_output_tps"),
)
summary = {
    "lane": "W3_QWEN35_BLOCK_TABLE_SKIP_C16_QUICK_A857C166",
    "status": "passed",
...
(root / "summary.txt").write_text("W3 QWEN35 BLOCK TABLE SKIP C16 QUICK DIAG PASS: " + str(root) + "\n")
PY
