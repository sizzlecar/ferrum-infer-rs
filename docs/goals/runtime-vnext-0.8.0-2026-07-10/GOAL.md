...
冻结 M3 legacy Metal 的已证实 32 GiB capacity blocker 按
[`G00_M3_METAL_32GB_AMENDMENT.md`](G00_M3_METAL_32GB_AMENDMENT.md) 进入 G00；它不改变
G08C/G09/G10 在同一 Metal 硬件上的最终 correctness、headroom、swap 和 performance 目标。
