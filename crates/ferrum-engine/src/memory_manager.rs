...
use ferrum_core::{Error, MemoryHandle, MemoryManager, MemoryPressure, MemoryUsage, Result};
...
impl GpuMemoryManager {
    ...
    pub fn new(config: MemoryConfig) -> Self {
        ...
        info!(
            "Initializing GpuMemoryManager with {} GB GPU, {} GB CPU memory",
    ...
    fn available_gpu_memory(&self) -> usize {
        let total =
            (self.config.gpu_memory_bytes as f32 * self.config.gpu_memory_fraction) as usize;
