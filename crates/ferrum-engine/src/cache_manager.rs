...
use ferrum_core::{BlockId, CacheManager, CacheStats, Error, KVBlock, Result, Tensor};
...
impl PagedKVCacheManager {
    ...
    pub fn new(config: CacheConfig) -> Self {
        info!(
            "Initializing PagedKVCacheManager with {} GPU blocks, {} CPU blocks",
...
impl CacheManager for PagedKVCacheManager {
    ...
    async fn defragment(&self) -> Result<()> {
        ...
        info!(
            "Defragmentation complete. Free blocks: {}/{}",
