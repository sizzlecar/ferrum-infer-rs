...
const LEGACY_LONG_SIGNATURES: &[&str] = &[
    ...
    "crates/ferrum-kernels/src/backend/cuda/paged.rs::impl CudaBackend::method paged_varlen_attention (16)",
    ...
    "crates/ferrum-kernels/src/backend/traits.rs::trait BackendPagedKv::trait_fn paged_varlen_attention (16)",
    ...
    "crates/ferrum-models/src/models/llama_family_forward_batched.rs::impl LlamaFamilyModel::method unified_forward_layer (22)",
];
