...
pub(super) fn log_static_initialization_receipt(receipt: &StaticInitializationReceipt) {
    tracing::info!(
        ...
        transformed_component_count = receipt.transformed_component_count(),
        transformed_bytes = receipt.transformed_bytes(),
        ...
        transform_command_count = receipt.transform_command_count(),
