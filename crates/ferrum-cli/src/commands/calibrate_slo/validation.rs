...
impl ValidationModel {
    ...
    pub(super) async fn prepare(
        ...
        match source {
            manifest::ValidationSource::StructuredPrefixWholeWaveGroupV5 { .. } | manifest::ValidationSource::StructuredWholeWaveGroupV2 { .. } | manifest::ValidationSource::RequiredFutureAuditV2 { .. } | manifest::ValidationSource::StructuredDiscoveryV2 { .. } | manifest::ValidationSource::StructuredWholeWaveV1 { .. } | manifest::ValidationSource::StructuredWholeWaveV2 {..} => Err(FerrumError::internal(
