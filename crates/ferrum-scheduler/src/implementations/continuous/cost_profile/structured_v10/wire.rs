...
pub enum StructuredProfilePhaseV10 {
    Fit,
    Residual,
    Qualification,
}
impl StructuredProfilePhaseV10 {
    pub(super) fn native(self) -> StructuredPhaseV2 {
        match self {
            Self::Fit => StructuredPhaseV2::Fit,
            Self::Residual => StructuredPhaseV2::Residual,
            Self::Qualification => StructuredPhaseV2::Qualification,
        }
    }
...
pub struct StructuredPhaseProvenanceV10 {
    pub phase: StructuredProfilePhaseV10,
    pub members: usize,
...
pub(super) struct OfferedRow {
    ...
    pub generation: u64,
    pub generated: u64,
    pub work: OfferedWork,
}
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(rename_all = "snake_case", deny_unknown_fields)]
pub(super) enum OfferedWork {
    Decode {
        kv_tokens: u32,
    },
    Prefill {
...
impl OfferedWork {
    pub fn native(&self) -> PreparedWorkV2 {
        match *self {
            Self::Decode { kv_tokens } => PreparedWorkV2::Decode { kv_tokens },
            Self::Prefill {
                offset,
                count,
                total_prompt_tokens,
...
pub(super) struct Prepared {
    ...
    pub selected_independent_attention_v2: Option<IndependentAttentionWaveEvidenceWireV2>,
    pub recipe: Recipe,
    pub owner_facts: serde_json::Value,
    #[serde(deserialize_with = "bounded_rows")]
...
#[derive(Debug, Clone, Serialize, Deserialize)]
#[serde(deny_unknown_fields)]
pub(super) struct OutsideSettlement {
    pub call_id: u64,
