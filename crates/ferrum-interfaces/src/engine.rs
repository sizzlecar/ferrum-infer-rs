...
use ferrum_types::{InferenceRequest, InferenceResponse, Result, StreamChunk, EngineConfig};
...
pub trait AdvancedInferenceEngine: InferenceEngine {
    ...
    async fn warmup(&mut self, warmup_requests: Vec<InferenceRequest>) -> Result<ferrum_types::WarmupResult>;
