...
// Filled from the first bounded CUDA diagnostic after the fixture generator,
// source hashes, and reference semantics are frozen. Keeping the placeholder
// deliberately makes that diagnostic REJECT instead of manufacturing PASS.
