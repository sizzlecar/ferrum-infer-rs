...
// can call from cudarc. Only the (head_size=128, block_size=16, FP16)
// shape needed for Qwen3-30B-A3B is instantiated — covers M3 c=32 perf
// path. Other model shapes are out of scope until they land.
//
