...
// Stripped torch / ATen / c10 includes — vendored kernel uses pure CUDA
// types (half / __nv_bfloat16) inside the templated kernels. torch::Tensor
// unpacking lived only in the top-level dispatcher; ferrum's launcher.cu
