...
//
template <>
__device__ inline void dequant<half2, vllm::kU4B8Id_LITERAL, true>(int q,
                                                              half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, vllm::kU4B8Id_LITERAL, false>(int q,
                                                               half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, vllm::kU4Id_LITERAL, true>(int q,
                                                            half2* frag_b) {
  dequant<half2, vllm::kU4B8Id_LITERAL, true>(q, frag_b);
}

template <>
__device__ inline void dequant<half2, vllm::kU4Id_LITERAL, false>(int q,
                                                             half2* frag_b) {
  const int LO = 0x000f000f;
  const int HI = 0x00f000f0;
  const int EX = 0x64006400;
...
template <>
__device__ inline void dequant<nv_bfloat162, vllm::kU4B8Id_LITERAL, true>(
...
template <>
__device__ inline void dequant<nv_bfloat162, vllm::kU4B8Id_LITERAL, false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, vllm::kU4B8Id_LITERAL, true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, vllm::kU4Id_LITERAL, true>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, vllm::kU4B8Id_LITERAL, true>(q, frag_b);
}

template <>
__device__ inline void dequant<nv_bfloat162, vllm::kU4Id_LITERAL, false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, vllm::kU4Id_LITERAL, true>(q, frag_b);
...
//
template <>
__device__ inline void dequant<half2, vllm::kU8B128Id_LITERAL, true>(int q,
                                                                half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, vllm::kU8B128Id_LITERAL, false>(
    int q, half2* frag_b) {
  dequant<half2, vllm::kU8B128Id_LITERAL, true>(q, frag_b);
...
template <>
__device__ inline void dequant<half2, vllm::kU8Id_LITERAL, true>(int q,
                                                            half2* frag_b) {
  dequant<half2, vllm::kU8B128Id_LITERAL, true>(q, frag_b);
}

template <>
__device__ inline void dequant<half2, vllm::kU8Id_LITERAL, false>(int q,
                                                             half2* frag_b) {
  dequant<half2, vllm::kU8Id_LITERAL, true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, vllm::kU8B128Id_LITERAL, false>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, vllm::kU8Id_LITERAL, false>(
    int q, nv_bfloat162* frag_b) {
  float fp32_intermediates[4];
  uint32_t* fp32_intermediates_casted =
      reinterpret_cast<uint32_t*>(fp32_intermediates);
...
template <>
__device__ inline void dequant<half2, vllm::kFE4M3fnId_LITERAL, true>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, vllm::kFE4M3fnId_LITERAL, false>(
    int q, half2* frag_b) {
  dequant<half2, vllm::kFE4M3fnId_LITERAL, true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, vllm::kFE4M3fnId_LITERAL, true>(
    int q, nv_bfloat162* frag_b) {
...
template <>
__device__ inline void dequant<nv_bfloat162, vllm::kFE4M3fnId_LITERAL, false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, vllm::kFE4M3fnId_LITERAL, true>(q, frag_b);
...
template <>
__device__ inline void dequant<half2, 0LL /* kFE2M1fId not relevant for our build */, true>(int q,
                                                                half2* frag_b) {
...
template <>
__device__ inline void dequant<half2, 0LL /* kFE2M1fId not relevant for our build */, false>(
    int q, half2* frag_b) {
  dequant<half2, 0LL /* kFE2M1fId not relevant for our build */, true>(q, frag_b);
...
template <>
__device__ inline void dequant<nv_bfloat162, 0LL /* kFE2M1fId not relevant for our build */, true>(
    int q, nv_bfloat162* frag_b) {
  // Constants for FP4 (E2M1) and FP16 formats
...
template <>
__device__ inline void dequant<nv_bfloat162, 0LL /* kFE2M1fId not relevant for our build */, false>(
    int q, nv_bfloat162* frag_b) {
  dequant<nv_bfloat162, 0LL /* kFE2M1fId not relevant for our build */, true>(q, frag_b);
...
template <>
__device__ inline void dequant_fp8_scales<half2, vllm::kFE4M3fnId_LITERAL>(
    int q, half2* frag_b) {
...
template <>
__device__ inline void dequant_fp8_scales<nv_bfloat162, vllm::kFE4M3fnId_LITERAL>(
    int q, nv_bfloat162* frag_b) {
  constexpr int FP8_EXPONENT = 4, BF16_EXPONENT = 8;
  constexpr int RIGHT_SHIFT = BF16_EXPONENT - FP8_EXPONENT;
  constexpr int MASK = 0x7F007F00;
...
template <>
__device__ inline void dequant_fp8_scales<nv_bfloat162, vllm::kFE8M0fnuId_LITERAL>(
    int q, nv_bfloat162* frag_b) {
