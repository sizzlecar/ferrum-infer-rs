...
pub fn dispatch_gemm_q6k_moe_id_on_encoder(
    ...
    dispatch_gemm_q6k_moe_id_inner(
        device,
        enc,
        weights_stacked,
        weights_byte_offset,
...
/// Indirect-dispatch variant — see `q4_k_moe_id_gemm` for the rationale.
#[allow(clippy::too_many_arguments)]
pub fn dispatch_gemm_q6k_moe_id_indirect_on_encoder(
    device: &Device,
    enc: &ComputeCommandEncoderRef,
    weights_stacked: &Buffer,
    weights_byte_offset: u64,
...
#[allow(clippy::too_many_arguments)]
fn dispatch_gemm_q6k_moe_id_inner(
    device: &Device,
    enc: &ComputeCommandEncoderRef,
    weights_stacked: &Buffer,
    weights_byte_offset: u64,
