#!/usr/bin/env bash
#
# Build + run the standalone Gemma3 down_proj L2 persistence native-CUDA probe.
#
...
NVCC="${NVCC:-nvcc}"
ARCH="${ARCH:-sm_89}"
SRC="scripts/microbenches/gemma3_down_l2_persist_perf.cu"
OUT_BIN="${OUT_BIN:-/tmp/gemma3_down_l2_persist_perf}"
KERNEL_SRCS=(
