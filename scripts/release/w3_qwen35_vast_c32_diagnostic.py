...
DEFAULT_SHA = "e50ff975f1331a5f3ae967fddc2a5d768fd983b4"
DEFAULT_TAG = "recompute_reopens_from_kv_feedback"
...
def main() -> int:
    ...
    plan = {
        "lane": "W3 Qwen35 c32 recompute-reopens-from-kv-feedback diagnostic",
