...
env \
    ...
    FERRUM_VLLM_MOE_LOG_CONFIG_MIN_PAIRS="${FERRUM_VLLM_MOE_LOG_CONFIG_MIN_PAIRS:-$((CONCURRENCY * TOP_K))}" \
    FERRUM_VLLM_MOE_LOG_CONFIG_MAX_PAIRS="${FERRUM_VLLM_MOE_LOG_CONFIG_MAX_PAIRS:-$((CONCURRENCY * TOP_K))}" \
